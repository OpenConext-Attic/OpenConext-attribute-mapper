...
public class DefaultSAMLEntryPointTest {
  ...
  @Test
  public void testCommenceToSurfConext() throws Exception {
    SecurityContextHolder.getContext().setAuthentication(new TestingAuthenticationToken(new User(), "N/A"));
    doCommence("surfconext-entity-id");
  }
